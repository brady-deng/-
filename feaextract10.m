function [ f ] = feaextract10( T,index,flowt,spt )
%UNTITLED5 Summary of this function goes here
%   Detailed explanation goes here

    s1 = ['data = importdata(''E:\文档\MATLAB程序\ucd-process\UCD Sleep Apnea Database\数据\',num2str(T),'.mat'');'];
    eval(s1);
%     index = input('Please input the index of the subject you want to extract:');
    ...
    %         tempL(tempob) = 
            s1008 = ['spmax = FindSp10(d.Sp',num2str(i),',spt);'];
            eval(s1008);
            % 呼吸流量峰值
    ...
    %   tempmin，附近窗口长度加ST的时间段内的第二小的值
        ...
        tempzero = find(tempL == 0);
        s1008 = ['spmax = FindSp10(d.Sp',num2str(index),',spt);'];
        eval(s1008);
        % 呼吸流量峰值
